...
class MultinestSampler(ParallelSampler):
    ...
    def config(self):
        ...
        # ------------- otavio begin -----------------
        self.min_weight = self.read_ini("min_weight", float, default=0.0)
        # -------------- otavio end ------------------
    ...
    def output_params(self, n, live, posterior, log_z, ins_log_z, log_z_err):
        ...
        # ----------- otavio begin ----------
        #
        # If weight <= min_weight, do not output the point.
        # Subtract from nsample the number of removed points
        # 
